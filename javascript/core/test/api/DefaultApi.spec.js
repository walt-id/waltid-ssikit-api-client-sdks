...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WaltIdCoreApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('presentVc', function() {
      it('should call presentVc successfully', function(done) {
        //uncomment below and update the code to test presentVc
        //instance.presentVc(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
