...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WaltIdCustodianApi.GenerateKeyRequest();
  });
  ...
  describe('GenerateKeyRequest', function() {
    it('should create an instance of GenerateKeyRequest', function() {
      // uncomment below and update the code to test GenerateKeyRequest
      //var instance = new WaltIdCustodianApi.GenerateKeyRequest();
      //expect(instance).to.be.a(WaltIdCustodianApi.GenerateKeyRequest);
    });
