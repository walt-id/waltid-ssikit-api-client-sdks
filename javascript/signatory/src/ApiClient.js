...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://signatory.ssikit.walt.id') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://signatory.ssikit.walt.id
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.1-SNAPSHOT/Javascript'
        };
