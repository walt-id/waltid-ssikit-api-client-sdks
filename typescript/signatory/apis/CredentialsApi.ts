...
export class CredentialsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async issue(issueCredentialRequest?: IssueCredentialRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;


        // Path Params
        const localVarPath = '/v1/credentials/issue';
...
export class CredentialsApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to issue
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async issue(response: ResponseContext): Promise<string > {
