...
export class VerifiableCredentialsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async loadTemplate(id: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("VerifiableCredentialsApi", "loadTemplate", "id");
        }
...
export class VerifiableCredentialsApiResponseProcessor {
     ...
     */
     public async listTemplates(response: ResponseContext): Promise<Array<string> > {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to loadTemplate
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async loadTemplate(response: ResponseContext): Promise<string > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
